...
of **problems**; each problem has a group of numbers that need to be either **added** (`+`) or **multiplied** (`*`)
together.
...
significant digit at the top and the least significant digit at the bottom. (Problems are still separated with a column
consisting only of spaces, and the symbol at the bottom of the problem is still the operator to use.)
